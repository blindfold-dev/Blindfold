...
public class HuTaxIdDetector extends RegexDetector {

    static {
        DetectorRegistry.registerRegion("hu", HuTaxIdDetector::new);
    }
    ...
    public Predicate<String> getValidator() {
        return Validators::huTaxIdChecksum;
    }
}
