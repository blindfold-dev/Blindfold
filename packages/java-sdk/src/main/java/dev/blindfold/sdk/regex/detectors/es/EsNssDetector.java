...
public class EsNssDetector extends RegexDetector {

    static {
        DetectorRegistry.registerRegion("es", EsNssDetector::new);
    }
    ...
    public Predicate<String> getValidator() {
        return Validators::esNssChecksum;
    }
}
