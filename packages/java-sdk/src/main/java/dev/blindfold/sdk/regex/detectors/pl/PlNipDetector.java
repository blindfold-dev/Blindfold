...
public class PlNipDetector extends RegexDetector {

    static {
        DetectorRegistry.registerRegion("pl", PlNipDetector::new);
    }
    ...
    public Predicate<String> getValidator() {
        return Validators::plNipChecksum;
    }
}
