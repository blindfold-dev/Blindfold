...
public class SeOrgnrDetector extends RegexDetector {

    static {
        DetectorRegistry.registerRegion("se", SeOrgnrDetector::new);
    }
    ...
    public Predicate<String> getValidator() {
        return Validators::seOrgnrChecksum;
    }
}
