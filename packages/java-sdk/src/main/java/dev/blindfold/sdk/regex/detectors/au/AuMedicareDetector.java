...
public class AuMedicareDetector extends RegexDetector {

    static {
        DetectorRegistry.registerRegion("au", AuMedicareDetector::new);
    }
    ...
    public Predicate<String> getValidator() {
        return Validators::auMedicareChecksum;
    }
}
