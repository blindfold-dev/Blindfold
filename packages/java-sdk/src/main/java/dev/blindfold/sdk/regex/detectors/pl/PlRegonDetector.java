...
public class PlRegonDetector extends RegexDetector {

    static {
        DetectorRegistry.registerRegion("pl", PlRegonDetector::new);
    }
    ...
    public Predicate<String> getValidator() {
        return Validators::plRegonChecksum;
    }
}
